...
local Library, Esp, MiscOptions, Options = loadstring(game:HttpGet("https://raw.githubusercontent.com/chrisu-sudo/sssssaask/refs/heads/main/libary.lua"))()
local Holder = Library:Window({Name = "Sakura"})
